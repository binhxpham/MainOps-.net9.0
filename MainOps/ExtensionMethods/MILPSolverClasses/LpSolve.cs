...
{
    public sealed class LpSolve : IDisposable
    {
        ...
        public bool str_add_column(string colString)
        {
            return Interop.str_add_column(_lp, colString);
        }
        ...
        public bool set_column(int colNo, double[] column)
        {
            return Interop.set_column(_lp, colNo, column);
        }

        public bool set_columnex(int colNo, int count, double[] column, int[] rowno)
        {
            return Interop.set_columnex(_lp, colNo, count, column, rowno);
        }

        // http://lpsolve.sourceforge.net/5.5/get_column.htm

        public bool get_column(int colNr, double[] column)
        {
            return Interop.get_column(_lp, colNr, column);
        }

        public int get_columnex(int colNr, double[] column, int[] nzrow)
        {
            return Interop.get_columnex(_lp, colNr, column, nzrow);
        }

        // http://lpsolve.sourceforge.net/5.5/set_col_name.htm

        public bool set_col_name(int column, string newName)
        {
            return Interop.set_col_name(_lp, column, newName);
        }
        ...
        public bool set_int(int column, bool mustBeInt)
        {
            return Interop.set_int(_lp, column, mustBeInt);
        }
        ...
        public bool set_binary(int column, bool mustBeBin)
        {
            return Interop.set_binary(_lp, column, mustBeBin);
        }
        ...
        public bool set_semicont(int column, bool mustBeSc)
        {
            return Interop.set_semicont(_lp, column, mustBeSc);
        }
        ...
        public bool add_constraint(double[] row, lpsolve_constr_types constrType, double rh)
        {
            return Interop.add_constraint(_lp, row, constrType, rh);
        }

        public bool add_constraintex(int count, double[] row, int[] colno, lpsolve_constr_types constrType, double rh)
        {
            return Interop.add_constraintex(_lp, count, row, colno, constrType, rh);
        }

        public bool str_add_constraint(string rowString, lpsolve_constr_types constrType, double rh)
        {
            return Interop.str_add_constraint(_lp, rowString, constrType, rh);
        }

        public bool del_constraint(int delRow)
        {
            return Interop.del_constraint(_lp, delRow);
        }

        public bool get_row(int rowNr, double[] row)
        {
            return Interop.get_row(_lp, rowNr, row);
        }

        public int get_rowex(int rowNr, double[] row, int[] colno)
        {
            return Interop.get_rowex(_lp, rowNr, row, colno);
        }

        // http://lpsolve.sourceforge.net/5.5/set_row.htm

        public bool set_row(int rowNo, double[] row)
        {
            return Interop.set_row(_lp, rowNo, row);
        }

        public bool set_rowex(int rowNo, int count, double[] row, int[] colno)
        {
            return Interop.set_rowex(_lp, rowNo, count, row, colno);
        }

        // http://lpsolve.sourceforge.net/5.5/set_row_name.htm

        public bool set_row_name(int row, string newName)
        {
            return Interop.set_row_name(_lp, row, newName);
        }
        ...
        public bool set_constr_type(int row, lpsolve_constr_types conType)
        {
            return Interop.set_constr_type(_lp, row, conType);
        }
        ...
        public bool str_set_rh_vec(string rhString)
        {
            return Interop.str_set_rh_vec(_lp, rhString);
        }
        ...
        public void set_obj_bound(double objBound)
        {
            Interop.set_obj_bound(_lp, objBound);
        }
        ...
        public bool str_set_obj_fn(string rowString)
        {
            return Interop.str_set_obj_fn(_lp, rowString);
        }
        ...
        public bool set_var_branch(int column, lpsolve_branch branchMode)
        {
            return Interop.set_var_branch(_lp, column, branchMode);
        }
        ...
        public void set_maxpivot(int maxNumInv)
        {
            Interop.set_maxpivot(_lp, maxNumInv);
        }
        ...
        public void set_pivoting(lpsolve_piv_rules pivRule)
        {
            Interop.set_pivoting(_lp, pivRule);
        }
        ...
        public void set_break_at_first(bool breakAtFirst)
        {
            Interop.set_break_at_first(_lp, breakAtFirst);
        }
        ...
        public void set_break_at_value(double breakAtValue)
        {
            Interop.set_break_at_value(_lp, breakAtValue);
        }
        ...
        public void set_bb_rule(lpsolve_BBstrategies bbRule)
        {
            Interop.set_bb_rule(_lp, bbRule);
        }
        ...
        public void set_bb_depthlimit(int bbMaxlevel)
        {
            Interop.set_bb_depthlimit(_lp, bbMaxlevel);
        }
        ...
        public void set_bb_floorfirst(lpsolve_branch bbFloorfirst)
        {
            Interop.set_bb_floorfirst(_lp, bbFloorfirst);
        }
        ...
        public void set_mip_gap(bool absolute, double mipGap)
        {
            Interop.set_mip_gap(_lp, absolute, mipGap);
        }
        ...
        public void set_anti_degen(lpsolve_anti_degen antiDegen)
        {
            Interop.set_anti_degen(_lp, antiDegen);
        }
        ...
        public void set_use_names(bool isrow, bool useNames)
        {
            Interop.set_use_names(_lp, isrow, useNames);
        }
        ...
        public void set_presolve(lpsolve_presolve doPresolve, int maxloops)
        {
            Interop.set_presolve(_lp, doPresolve, maxloops);
        }
        ...
        public void set_print_sol(int printSol)
        {
            Interop.set_print_sol(_lp, printSol);
        }
        ...
        public int get_lp_index(int origIndex)
        {
            return Interop.get_lp_index(_lp, origIndex);
        }

        public int get_orig_index(int lpIndex)
        {
            return Interop.get_orig_index(_lp, lpIndex);
        }

...
namespace MainOps.Migrations
{
    ...
    [Migration("20210310115310_startingover")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MainOps.Models.BentoniteLayer", b =>
                {
                    ...
                    b.HasIndex("LayerTypeOverId");

                    b.HasIndex("LayerTypeUnderId");
            ...
            modelBuilder.Entity("MainOps.Models.WellDrillingInstruction", b =>
                {
                    ...
                    b.Property<double>("Filter1_Grus_Ned");

                    b.Property<double>("Filter1_Grus_Op");

                    b.Property<double>("Filter1_Laengde");

                    b.Property<string>("Filter2_Dim");

                    b.Property<double?>("Filter2_Grus_Ned");

                    b.Property<double?>("Filter2_Grus_Op");
            ...
            modelBuilder.Entity("MainOps.Models.BentoniteLayer", b =>
                {
                    b.HasOne("MainOps.Models.LayerType", "LayerTypeOver")
                        .WithMany()
                        .HasForeignKey("LayerTypeOverId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MainOps.Models.LayerType", "LayerTypeUnder")
                        .WithMany()
                        .HasForeignKey("LayerTypeUnderId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("MainOps.Models.PhotoFileWorkItem", b =>
                {
                    b.HasOne("MainOps.Models.WorkItem")
                        .WithMany("Photos")
            ...
            modelBuilder.Entity("MainOps.Models.WorkItem", b =>
                {
                    b.HasOne("MainOps.Models.WorkTask")
                        .WithMany("WorkItems")
            ...
            modelBuilder.Entity("MainOps.Models.WorkTask", b =>
                {
                    b.HasOne("MainOps.Models.ApplicationUser", "InCharge")
                        .WithMany("InChargeTasks")
                    ...
                    b.HasOne("MainOps.Models.ApplicationUser", "Worker")
